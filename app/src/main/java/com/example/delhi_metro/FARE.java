...
public class FARE extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        src = (AutoCompleteTextView) findViewById(R.id.autoCompleteTextView3);
        dest = (AutoCompleteTextView) findViewById(R.id.autoCompleteTextView);
        ...
        submitrt.setOnClickListener(new View.OnClickListener() {
            ...
            if(source!=destination) {
                ...
                if(fare!=-1)
                Toast.makeText(getApplicationContext(), "Total fare to reach destination  = "+fare+" rupees", Toast.LENGTH_SHORT).show();
